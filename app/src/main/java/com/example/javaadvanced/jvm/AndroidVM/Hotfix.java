...
public class Hotfix {
    ...
    public static void installPatch(Application application, File patch) {
        //1、获得classloader，即PathClassLoader
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) { //24 7.0及以上
            try {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) { //23 6.0及以上
                    V23.install(classLoader, files, dexOptDir);
                } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {//19 4.4及以上
