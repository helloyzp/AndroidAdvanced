...
/**
 * Special TabHost that allows the use of {@link androidx.fragment.app.Fragment} objects for
 * its tab content.  When placing this in a view hierarchy, after inflating
 * the hierarchy you must call {@link #setup(Context, androidx.fragment.app.FragmentManager, int)}
...
public class FragmentTabHost extends TabHost
     ...
     * call {@link #setup(Context, androidx.fragment.app.FragmentManager)} or
     * {@link #setup(Context, androidx.fragment.app.FragmentManager, int)}.
     */
    @Override @Deprecated
    public void setup() {
    ...
    public void setup(Context context, androidx.fragment.app.FragmentManager manager) {
