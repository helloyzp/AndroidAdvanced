 ...
 * FragmentController为Fragment的宿主提供一个控制器，对Fragment生命周期操作，提供一个控制流程。
 * FragmentController中持有FragmentHostCallback对象，对于Fragment生命周期的操作，主要是通过FragmentHostCallback来实现的。
 * 而FragmentHostCallback中的操作，则主要通过FragmentManagerImpl来实现。
 * 基本上你可以认为FragmentController是FragmentManager的代理，
 * Activity需要的FragmentController的函数，最后调用的都是FragmentHostCallback中的FragmentManager的方法
 */
public class FragmentController {
     ...
     */
    public List<androidx.fragment.app.Fragment> getActiveFragments(List<androidx.fragment.app.Fragment> actives) {
     ...
     */
    public void attachHost(androidx.fragment.app.Fragment parent) {
     ...
     */
    @Deprecated
    public void restoreAllState(Parcelable state, List<androidx.fragment.app.Fragment> nonConfigList) {
     ...
     */
    @Deprecated
    public List<androidx.fragment.app.Fragment> retainNonConfig() {
     ...
     *
     * @see androidx.fragment.app.Fragment#onActivityCreated(Bundle)
     */
