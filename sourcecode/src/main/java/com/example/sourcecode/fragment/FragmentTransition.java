...
class FragmentTransition {
    ...
    private static final int[] INVERSE_OPS = {
            androidx.fragment.app.BackStackRecord.OP_NULL,              // inverse of OP_NULL (error)
            androidx.fragment.app.BackStackRecord.OP_REMOVE,            // inverse of OP_ADD
            androidx.fragment.app.BackStackRecord.OP_NULL,              // inverse of OP_REPLACE (error)
            androidx.fragment.app.BackStackRecord.OP_ADD,               // inverse of OP_REMOVE
            androidx.fragment.app.BackStackRecord.OP_SHOW,              // inverse of OP_HIDE
            androidx.fragment.app.BackStackRecord.OP_HIDE,              // inverse of OP_SHOW
            androidx.fragment.app.BackStackRecord.OP_ATTACH,            // inverse of OP_DETACH
            androidx.fragment.app.BackStackRecord.OP_DETACH,            // inverse of OP_ATTACH
            androidx.fragment.app.BackStackRecord.OP_UNSET_PRIMARY_NAV, // inverse of OP_SET_PRIMARY_NAV
            androidx.fragment.app.BackStackRecord.OP_SET_PRIMARY_NAV,   // inverse of OP_UNSET_PRIMARY_NAV
    };

    private static final androidx.fragment.app.FragmentTransitionImpl PLATFORM_IMPL = Build.VERSION.SDK_INT >= 21
            ? new FragmentTransitionCompat21()
            : null;

    private static final androidx.fragment.app.FragmentTransitionImpl SUPPORT_IMPL = resolveSupportImpl();

    private static androidx.fragment.app.FragmentTransitionImpl resolveSupportImpl() {
        try {
            @SuppressWarnings("unchecked")
            Class<androidx.fragment.app.FragmentTransitionImpl> impl = (Class<androidx.fragment.app.FragmentTransitionImpl>) Class.forName(
     ...
     * set on the leaving Fragment's {@link androidx.fragment.app.Fragment#getExitTransition()}, the
     * entering Fragment's {@link androidx.fragment.app.Fragment#getEnterTransition()} and
     * {@link androidx.fragment.app.Fragment#getSharedElementEnterTransition()}. When popping,
     * the leaving Fragment's {@link androidx.fragment.app.Fragment#getReturnTransition()} and
     * {@link androidx.fragment.app.Fragment#getSharedElementReturnTransition()} and the entering
     * {@link androidx.fragment.app.Fragment#getReenterTransition()} will be run.
     * <p>
     ...
     */
    static void startTransitions(androidx.fragment.app.FragmentManagerImpl fragmentManager,
                                 ArrayList<androidx.fragment.app.BackStackRecord> records, ArrayList<Boolean> isRecordPop,
                                 int startIndex, int endIndex, boolean isReordered) {
        if (fragmentManager.mCurState < androidx.fragment.app.Fragment.CREATED) {
            return;
        }
     ...
     *                      {@link androidx.fragment.app.FragmentTransaction#addSharedElement(View, String)}.
     */
    private static void configureTransitionsReordered(androidx.fragment.app.FragmentManagerImpl fragmentManager,
        ...
        final androidx.fragment.app.Fragment inFragment = fragments.lastIn;
        final androidx.fragment.app.Fragment outFragment = fragments.firstOut;
        final androidx.fragment.app.FragmentTransitionImpl impl = chooseImpl(outFragment, inFragment);
        if (impl == null) {
            return;
        }
     ...
     */
    private static void replaceHide(androidx.fragment.app.FragmentTransitionImpl impl,
                                    Object exitTransition, androidx.fragment.app.Fragment exitingFragment,
     ...
     *                      {@link androidx.fragment.app.FragmentTransaction#addSharedElement(View, String)}.
     */
    private static void configureTransitionsOrdered(androidx.fragment.app.FragmentManagerImpl fragmentManager,
                                                    int containerId, FragmentContainerTransition fragments,
                                                    View nonExistentView, ArrayMap<String, String> nameOverrides) {
        ViewGroup sceneRoot = null;
        if (fragmentManager.mContainer.onHasView()) {
     ...
     */
    private static void scheduleTargetChange(final androidx.fragment.app.FragmentTransitionImpl impl,
                                             final ViewGroup sceneRoot,
                                             final androidx.fragment.app.Fragment inFragment, final View nonExistentView,
     ...
     * Fragments.
     */
    private static androidx.fragment.app.FragmentTransitionImpl chooseImpl(androidx.fragment.app.Fragment outFragment, androidx.fragment.app.Fragment inFragment) {
    ...
    private static boolean canHandleAll(androidx.fragment.app.FragmentTransitionImpl impl, List<Object> transitions) {
     ...
     * exists.
     */
    private static Object getSharedElementTransition(androidx.fragment.app.FragmentTransitionImpl impl,
                                                     androidx.fragment.app.Fragment inFragment, androidx.fragment.app.Fragment outFragment, boolean isPop) {
     ...
     */
    private static Object getEnterTransition(androidx.fragment.app.FragmentTransitionImpl impl,
                                             androidx.fragment.app.Fragment inFragment, boolean isPop) {
        if (inFragment == null) {
            return null;
        }
     ...
     */
    private static Object getExitTransition(androidx.fragment.app.FragmentTransitionImpl impl,
                                            androidx.fragment.app.Fragment outFragment, boolean isPop) {
        if (outFragment == null) {
            return null;
        }
        return impl.cloneTransition(isPop
     ...
     */
    private static Object configureSharedElementsReordered(final androidx.fragment.app.FragmentTransitionImpl impl,
            final ViewGroup sceneRoot,
        ...
        if (sharedElementTransition != null) {
            ...
            final boolean outIsPop = fragments.firstOutIsPop;
            final androidx.fragment.app.BackStackRecord outTransaction = fragments.firstOutTransaction;
     ...
     * @return The shared element transition or null if no shared elements exist
     */
    private static Object configureSharedElementsOrdered(final androidx.fragment.app.FragmentTransitionImpl impl,
            final ViewGroup sceneRoot,
            final View nonExistentView, final ArrayMap<String, String> nameOverrides,
            final FragmentContainerTransition fragments,
            final ArrayList<View> sharedElementsOut,
     ...
     */
    private static ArrayMap<String, View> captureOutSharedElements(androidx.fragment.app.FragmentTransitionImpl impl,
     ...
     * if there is no shared element transition.
     */
    private static ArrayMap<String, View> captureInSharedElements(androidx.fragment.app.FragmentTransitionImpl impl,
                                                                  ArrayMap<String, String> nameOverrides, Object sharedElementTransition,
                                                                  FragmentContainerTransition fragments) {
        androidx.fragment.app.Fragment inFragment = fragments.lastIn;
        ...
        final SharedElementCallback sharedElementCallback;
        final ArrayList<String> names;
        final androidx.fragment.app.BackStackRecord inTransaction = fragments.lastInTransaction;
    ...
    private static View getInEpicenterView(ArrayMap<String, View> inSharedElements,
        ...
        androidx.fragment.app.BackStackRecord inTransaction = fragments.lastInTransaction;
     ...
     */
    private static void setOutEpicenter(androidx.fragment.app.FragmentTransitionImpl impl, Object sharedElementTransition,
                                        Object exitTransition, ArrayMap<String, View> outSharedElements, boolean outIsPop,
                                        androidx.fragment.app.BackStackRecord outTransaction) {
     ...
     */
    private static void callSharedElementStartEnd(androidx.fragment.app.Fragment inFragment, androidx.fragment.app.Fragment outFragment,
    ...
    private static ArrayList<View> configureEnteringExitingViews(androidx.fragment.app.FragmentTransitionImpl impl,
                                                                 Object transition,
                                                                 androidx.fragment.app.Fragment fragment, ArrayList<View> sharedElements, View nonExistentView) {
    ...
    private static Object mergeTransitions(FragmentTransitionImpl impl, Object enterTransition,
                                           Object exitTransition, Object sharedElementTransition, androidx.fragment.app.Fragment inFragment,
                                           boolean isPop) {
     ...
     *                               this method.
     */
    public static void calculateFragments(androidx.fragment.app.BackStackRecord transaction,
                                          SparseArray<FragmentContainerTransition> transitioningFragments,
                                          boolean isReordered) {
     ...
     *                               this method.
     */
    public static void calculatePopFragments(androidx.fragment.app.BackStackRecord transaction,
    ...
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord transaction, BackStackRecord.Op op,
                                            SparseArray<FragmentContainerTransition> transitioningFragments, boolean isPop,
                                            boolean isReorderedTransaction) {
        final androidx.fragment.app.Fragment fragment = op.fragment;
        if (fragment == null) {
        ...
        switch (command) {
            case androidx.fragment.app.BackStackRecord.OP_SHOW:
                ...
                wasAdded = true;
                break;
            case androidx.fragment.app.BackStackRecord.OP_ADD:
            case androidx.fragment.app.BackStackRecord.OP_ATTACH:
                if (isReorderedTransaction) {
                ...
                wasAdded = true;
                break;
            case androidx.fragment.app.BackStackRecord.OP_HIDE:
                if (isReorderedTransaction) {
                ...
                wasRemoved = true;
                break;
            case androidx.fragment.app.BackStackRecord.OP_REMOVE:
            case androidx.fragment.app.BackStackRecord.OP_DETACH:
                if (isReorderedTransaction) {
        ...
        if (!isReorderedTransaction && wasAdded) {
             ...
             */
            androidx.fragment.app.FragmentManagerImpl manager = transaction.mManager;
            if (fragment.mState < androidx.fragment.app.Fragment.CREATED && manager.mCurState >= androidx.fragment.app.Fragment.CREATED
                    && !transaction.mReorderingAllowed) {
                manager.makeActive(fragment);
                manager.moveToState(fragment, androidx.fragment.app.Fragment.CREATED, 0, 0, false);
            }
        }
