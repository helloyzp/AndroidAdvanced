...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    private ArrayList<androidx.fragment.app.Fragment.SavedState> mSavedState = new ArrayList<androidx.fragment.app.Fragment.SavedState>();
    private ArrayList<androidx.fragment.app.Fragment> mFragments = new ArrayList<androidx.fragment.app.Fragment>();
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (mFragments.size() > position) {
            androidx.fragment.app.Fragment f = mFragments.get(position);
            if (f != null) {
                return f;
            }
        }
        ...
        androidx.fragment.app.Fragment fragment = getItem(position);
        if (DEBUG) Log.v(TAG, "Adding item #" + position + ": f=" + fragment);
        if (mSavedState.size() > position) {
            androidx.fragment.app.Fragment.SavedState fss = mSavedState.get(position);
            if (fss != null) {
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (DEBUG) Log.v(TAG, "Removing item #" + position + ": f=" + object
                + " v=" + ((androidx.fragment.app.Fragment)object).getView());
    ...
    public Parcelable saveState() {
        ...
        if (mSavedState.size() > 0) {
            state = new Bundle();
            androidx.fragment.app.Fragment.SavedState[] fss = new androidx.fragment.app.Fragment.SavedState[mSavedState.size()];
            mSavedState.toArray(fss);
            state.putParcelableArray("states", fss);
        }
        for (int i=0; i<mFragments.size(); i++) {
            androidx.fragment.app.Fragment f = mFragments.get(i);
            if (f != null && f.isAdded()) {
                if (state == null) {
                    state = new Bundle();
                }
        ...
        if (state != null) {
            ...
            if (fss != null) {
                for (int i=0; i<fss.length; i++) {
                    mSavedState.add((androidx.fragment.app.Fragment.SavedState)fss[i]);
                }
            }
