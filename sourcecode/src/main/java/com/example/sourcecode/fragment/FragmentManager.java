 ...
 *
 * <p>Your activity must derive from {@link androidx.fragment.app.FragmentActivity} to use this. From such an activity,
 * you can acquire the {@link FragmentManager} by calling
 * {@link androidx.fragment.app.FragmentActivity#getSupportFragmentManager}.
 * FragmentManager，顾名思义，就是Fragment的真正管理类，主要提供了对Fragment进行操作。实际开发中，对Fragment进行操作的方法，
 * 例如beginTransaction()，popBackStack()都是通过该类来获取的。需要注意的是，FragmentManager为一个抽象类，
 * 真正的实现类为FragmentManagerImpl
 */
public abstract class FragmentManager {
     ...
     * {@link androidx.fragment.app.Fragment#postponeEnterTransition()} has been called.
     *
     ...
     */
    @Nullable
    public abstract androidx.fragment.app.Fragment findFragmentById(@IdRes int id);
     ...
     */
    @Nullable
    public abstract androidx.fragment.app.Fragment findFragmentByTag(@Nullable String tag);
     ...
     * placed with {@link #putFragment(Bundle, String, androidx.fragment.app.Fragment)}.
     *
     ...
     */
    @Nullable
    public abstract androidx.fragment.app.Fragment getFragment(@NonNull Bundle bundle, @NonNull String key);
     ...
     */
    @NonNull
    public abstract List<androidx.fragment.app.Fragment> getFragments();
     ...
     * that is it can't use {@link #putFragment(Bundle, String, androidx.fragment.app.Fragment)} to
     ...
     */
    @Nullable
    public abstract androidx.fragment.app.Fragment.SavedState saveFragmentInstanceState(androidx.fragment.app.Fragment f);
     ...
     * {@link FragmentTransaction#setPrimaryNavigationFragment(androidx.fragment.app.Fragment)}.
     *
    ...
    public abstract static class FragmentLifecycleCallbacks {
        /**
         * Called right before the fragment's {@link androidx.fragment.app.Fragment#onAttach(Context)} method is called.
         ...
         */
        public void onFragmentPreAttached(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
         ...
         */
        public void onFragmentAttached(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
                @NonNull Context context) {}

        /**
         * Called right before the fragment's {@link androidx.fragment.app.Fragment#onCreate(Bundle)} method is called.
         * This is a good time to inject any required dependencies or perform other configuration
         * for the fragment.
         *
         * @param fm Host FragmentManager
         ...
         */
        public void onFragmentPreCreated(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
                @Nullable Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onCreate(Bundle)}. This will only happen once for any given
         ...
         * @param savedInstanceState Saved instance bundle from a previous instance
         */
        public void onFragmentCreated(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
                @Nullable Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onActivityCreated(Bundle)}. This will only happen once for any given
         * fragment instance, though the fragment may be attached and detached multiple times.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         * @param savedInstanceState Saved instance bundle from a previous instance
         */
        public void onFragmentActivityCreated(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
                @Nullable Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned a non-null view from the FragmentManager's
         * request to {@link androidx.fragment.app.Fragment#onCreateView(LayoutInflater, ViewGroup, Bundle)}.
         *
         * @param fm Host FragmentManager
         ...
         * @param savedInstanceState Saved instance bundle from a previous instance
         */
        public void onFragmentViewCreated(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
                @NonNull View v, @Nullable Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onStart()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        public void onFragmentStarted(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onResume()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        public void onFragmentResumed(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onPause()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        public void onFragmentPaused(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f) {}
         ...
         * @param f Fragment changing state
         */
        public void onFragmentStopped(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f) {}
         ...
         */
        public void onFragmentSaveInstanceState(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f,
                @NonNull Bundle outState) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onDestroyView()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        public void onFragmentViewDestroyed(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onDestroy()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        ...
        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link androidx.fragment.app.Fragment#onDetach()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        public void onFragmentDetached(@NonNull FragmentManager fm, @NonNull androidx.fragment.app.Fragment f) {}
    }
}

/**
 * FragmentManagerState实现了Parcelable序列化接口，主要用于FragmentManager状态保存。
 * 当Activity内存不足被销毁时，保存FragmentManager的当前状态，等到再次启动Activity时，恢复FragmentManager中的Fragment对象。
 * 其中，包含了Fragment.FragmentState数组和BackStatckRecord.BackStackState数组，
 * 分别保存Fragment的状态信息和Fragment事务（BackStatckRecord）的状态信息
 */
final class FragmentManagerState implements Parcelable {
    ...
    public FragmentManagerState(Parcel in) {
        ...
        mBackStack = in.createTypedArray(androidx.fragment.app.BackStackState.CREATOR);
...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    SparseArray<androidx.fragment.app.Fragment> mActive;
    ArrayList<androidx.fragment.app.BackStackRecord> mBackStack;返回栈 BackStackRecord的返回栈
    ...
    int mCurState = androidx.fragment.app.Fragment.INITIALIZING;
    ...
    ArrayList<androidx.fragment.app.BackStackRecord> mTmpRecords;//用于优化执行的临时变量
    ...
    @Override
    public void putFragment(Bundle bundle, String key, androidx.fragment.app.Fragment fragment) {
    ...
    @Override
    @Nullable
    public androidx.fragment.app.Fragment getFragment(Bundle bundle, String key) {
        int index = bundle.getInt(key, -1);
        if (index == -1) {
            return null;
        }
        androidx.fragment.app.Fragment f = mActive.get(index);
        if (f == null) {
    ...
    public List<androidx.fragment.app.Fragment> getFragments() {
        ...
        synchronized (mAdded) {
            return (List<androidx.fragment.app.Fragment>) mAdded.clone();
        }
    }
     ...
     * back stack.
     */
    List<androidx.fragment.app.Fragment> getActiveFragments() {
        if (mActive == null) {
            return null;
        }
        final int count = mActive.size();
        ArrayList<androidx.fragment.app.Fragment> fragments = new ArrayList<>(count);
    ...
    public androidx.fragment.app.Fragment.SavedState saveFragmentInstanceState(androidx.fragment.app.Fragment fragment) {
        ...
        if (fragment.mState > androidx.fragment.app.Fragment.INITIALIZING) {
            Bundle result = saveFragmentBasicState(fragment);
            return result != null ? new androidx.fragment.app.Fragment.SavedState(result) : null;
        }
        return null;
    }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (mActive != null) {
            ...
            if (N > 0) {
                writer.print(prefix); writer.print("Active Fragments in ");
                        ...
                        writer.println(":");
                for (int i=0; i<N; i++) {
                    androidx.fragment.app.Fragment f = mActive.valueAt(i);
        ...
        if (N > 0) {
            ...
            for (int i = 0; i < N; i++) {
                androidx.fragment.app.Fragment f = mAdded.get(i);
                writer.print(prefix);
                writer.print("  #");
                writer.print(i);
                writer.print(": ");
        ...
        if (mCreatedMenus != null) {
            ...
            if (N > 0) {
                ...
                for (int i=0; i<N; i++) {
                    androidx.fragment.app.Fragment f = mCreatedMenus.get(i);
                    writer.print(prefix); writer.print("  #"); writer.print(i);
        ...
        if (mBackStack != null) {
            ...
            if (N > 0) {
                ...
                for (int i=0; i<N; i++) {
                    androidx.fragment.app.BackStackRecord bs = mBackStack.get(i);
                    writer.print(prefix); writer.print("  #"); writer.print(i);
        ...
        synchronized (this) {
            if (mBackStackIndices != null) {
                ...
                if (N > 0) {
                    ...
                    for (int i=0; i<N; i++) {
                        androidx.fragment.app.BackStackRecord bs = mBackStackIndices.get(i);
                        writer.print(prefix); writer.print("  #"); writer.print(i);
    ...
    AnimationOrAnimator loadAnimation(androidx.fragment.app.Fragment fragment, int transit, boolean enter,
                                      int transitionStyle) {
    ...
    public void performPendingDeferredStart(androidx.fragment.app.Fragment f) {
        if (f.mDeferStart) {
    ...
    void moveToState(androidx.fragment.app.Fragment f, int newState, int transit, int transitionStyle,
                     boolean keepActive) {
        // Fragments that are not currently added will sit in the onCreate() state.
         // Fragment尚未被加入的话会一直停留在CREATED状态
        if ((!f.mAdded || f.mDetached) && newState > androidx.fragment.app.Fragment.CREATED) {
            newState = androidx.fragment.app.Fragment.CREATED;
        }
        if (f.mRemoving && newState > f.mState) {
            if (f.mState == androidx.fragment.app.Fragment.INITIALIZING && f.isInBackStack()) {
        ...
        if (f.mDeferStart && f.mState < androidx.fragment.app.Fragment.STARTED && newState > androidx.fragment.app.Fragment.ACTIVITY_CREATED) {
            newState = androidx.fragment.app.Fragment.ACTIVITY_CREATED;
        }
        ...
        if (f.mState <= newState) { //状态复原：fragment创建或出栈等
			...
			//第一类是正向的切换顺序，INITIALIZEING->CREATED->ACTIVITY_CREATED->STARTED->RESUMED，值变得越来越大，
			//代表着Fragment从初始化到可见可交互的状态
			
            //第二类是反向的切换顺序，RESUMED->STARTED->STOPPED->CREATED->INITALIZING，值变得越来越小，
            //代表着Fragment从可见可交互到与Activity分离的状态
            switch (f.mState) {
                case androidx.fragment.app.Fragment.INITIALIZING:// 当前fragment尚未被创建或者已经被destroy
                    if (newState > androidx.fragment.app.Fragment.INITIALIZING) {
                        ...
                        if (f.mSavedFragmentState != null) {
                            ...
                            if (!f.mUserVisibleHint) {
                                f.mDeferStart = true;
                                if (newState > androidx.fragment.app.Fragment.ACTIVITY_CREATED) {
                                    newState = androidx.fragment.app.Fragment.ACTIVITY_CREATED;
                                }
                            }
                        }
                        ...
                        if (f.mTarget != null) {
                            ...
                            if (f.mTarget.mState < androidx.fragment.app.Fragment.CREATED) {
                                moveToState(f.mTarget, androidx.fragment.app.Fragment.CREATED, 0, 0, true);
                            }
                        }
                        ...
                        if (!f.mCalled) {
                            throw new androidx.fragment.app.SuperNotCalledException("Fragment " + f
                        ...
                        if (!f.mIsCreated) {
                            ...
                            f.performCreate(f.mSavedFragmentState); // 调用FragmentonCreate方法
                            dispatchOnFragmentCreated(f, f.mSavedFragmentState, false);
                        } else {
                            f.restoreChildFragmentState(f.mSavedFragmentState);
                            f.mState = androidx.fragment.app.Fragment.CREATED;
                        }
                        f.mRetaining = false;
                    }
                    // fall through
                case androidx.fragment.app.Fragment.CREATED: // 当前fragment状态为已经被创建
                    // This is outside the if statement below on purpose; we want this to run
                    // even if we do a moveToState from CREATED => *, CREATED => CREATED, and
                    // * => CREATED as part of the case fallthrough above.
                    ensureInflatedFragmentView(f);

                    if (newState > androidx.fragment.app.Fragment.CREATED) {
                        ...
                        if (!f.mFromLayout) {
                            ...
                            if (f.mView != null) {
                                ...
                                f.onViewCreated(f.mView, f.mSavedFragmentState);//会触发Fragment 的onCreateView()。
                    ...
                    // fall through
                case androidx.fragment.app.Fragment.ACTIVITY_CREATED:
                    if (newState > androidx.fragment.app.Fragment.ACTIVITY_CREATED) {
                    ...
                    // fall through
                case androidx.fragment.app.Fragment.STARTED:
                    if (newState > androidx.fragment.app.Fragment.STARTED) {
            ...
            switch (f.mState) {// 当前状态处于倒退的状态，即走onPause->onDestroy这个流程
                case androidx.fragment.app.Fragment.RESUMED:
                    if (newState < androidx.fragment.app.Fragment.RESUMED) {
                        if (DEBUG) Log.v(TAG, "movefrom RESUMED: " + f);
                        f.performPause(); // 调用Fragment.onPause方法
                ...
                case androidx.fragment.app.Fragment.STARTED:
                    if (newState < androidx.fragment.app.Fragment.STARTED) {
                        ...
                        f.performStop(); // 调用Fragment.onStop方法
                ...
                case androidx.fragment.app.Fragment.ACTIVITY_CREATED:
                    if (newState < androidx.fragment.app.Fragment.ACTIVITY_CREATED) {
                        ...
                        f.performDestroyView(); // 调用Fragment.onDestroyView方法
                        ...
                        if (f.mView != null && f.mContainer != null) {
                            ...
                            if (mCurState > androidx.fragment.app.Fragment.INITIALIZING && !mDestroyed
                    ...
                    // fall through
                case androidx.fragment.app.Fragment.CREATED:
                    if (newState < androidx.fragment.app.Fragment.CREATED) {
                        if (mDestroyed) {
                        ...
                        if (f.getAnimatingAway() != null || f.getAnimator() != null) {
                            ...
                            if (!f.mRetaining) {
                                ...
                                f.mState = androidx.fragment.app.Fragment.INITIALIZING;
                            }
        ...
        if (f.mState != newState) { //fragment切换到新状态
     ...
     */
    private void animateRemoveFragment(@NonNull final androidx.fragment.app.Fragment fragment,
    ...
    void ensureInflatedFragmentView(androidx.fragment.app.Fragment f) {
        if (f.mFromLayout && !f.mPerformedCreateView) {
            ...
            if (f.mView != null) {
                ...
                f.onViewCreated(f.mView, f.mSavedFragmentState);// 调用Fragment.onCreateView方法
     ...
     * animations run during the {@link #showFragment(androidx.fragment.app.Fragment)} or {@link #hideFragment(androidx.fragment.app.Fragment)}
     * calls. After fragments are brought to their final state in
     * {@link #moveFragmentToExpectedState(androidx.fragment.app.Fragment)} the fragments that have been shown or
     ...
     */
    void completeShowHideFragment(final androidx.fragment.app.Fragment fragment) {
     ...
     */
    void moveFragmentToExpectedState(androidx.fragment.app.Fragment f) {
        if (f == null) {
            return;
        }
        int nextState = mCurState; //切换到预期状态
        if (f.mRemoving) {
            if (f.isInBackStack()) {//fragment在栈中，想要出栈
                nextState = Math.min(nextState, androidx.fragment.app.Fragment.CREATED);
            } else {
                nextState = Math.min(nextState, androidx.fragment.app.Fragment.INITIALIZING);
            }
        }
        moveToState(f, nextState, f.getNextTransition(), f.getNextTransitionStyle(), false); //据预期的状态执行相应生命周期方法

        if (f.mView != null) {
            // Move the view if it is out of order
            androidx.fragment.app.Fragment underFragment = findFragmentUnder(f);
    ...
    void moveToState(int newState, boolean always) {
        if (mHost == null && newState != androidx.fragment.app.Fragment.INITIALIZING) {
        ...
        if (mActive != null) {
            ...
            for (int i = 0; i < numAdded; i++) {
                androidx.fragment.app.Fragment f = mAdded.get(i);//遍历mAdded，切换每个fragment的生命周期到预期的状态下
            ...
            if (mNeedMenuInvalidate && mHost != null && mCurState == androidx.fragment.app.Fragment.RESUMED) {
    ...
    void makeInactive(androidx.fragment.app.Fragment f) {
        if (f.mIndex < 0) {
            return;
        }
    ...
    public void addFragment(androidx.fragment.app.Fragment fragment, boolean moveToStateNow) {
        ...
        if (!fragment.mDetached) {
            ...
            fragment.mAdded = true; //更新当前fragment 状态
     ...
     * {@link #completeShowHideFragment(androidx.fragment.app.Fragment)}.
     *
    ...
    @Override
    @Nullable
    public androidx.fragment.app.Fragment findFragmentById(int id) {
    ...
    @Override
    @Nullable
    public androidx.fragment.app.Fragment findFragmentByTag(@Nullable String tag) {
        if (tag != null) {
            // First look through added fragments.
            for (int i=mAdded.size()-1; i>=0; i--) {
                androidx.fragment.app.Fragment f = mAdded.get(i);
     ...
     * {@link androidx.fragment.app.Fragment#startPostponedEnterTransition()}
     */
    ...
    //用于给加入到返回栈的 BackStackRecord 分配 mIndex 下标
    public int allocBackStackIndex(androidx.fragment.app.BackStackRecord bse) {
        synchronized (this) {
            if (mAvailBackStackIndices == null || mAvailBackStackIndices.size() <= 0) {
                if (mBackStackIndices == null) {
                    mBackStackIndices = new ArrayList<androidx.fragment.app.BackStackRecord>();
                }
   ...
   //用来处理当 Activity 意外内存重启后恢复 Fragment 返回栈索引列表(mBackStackIndices)和可用索引列表(mAvailBackStackIndices)的
    public void setBackStackIndex(int index, androidx.fragment.app.BackStackRecord bse) {
        synchronized (this) {
            if (mBackStackIndices == null) {
                mBackStackIndices = new ArrayList<androidx.fragment.app.BackStackRecord>();
            }
     ...
     * now ready.
     */
    private void executePostponedTransaction(ArrayList<androidx.fragment.app.BackStackRecord> records,
     ...
     */
    private void removeRedundantOperationsAndExecute(ArrayList<androidx.fragment.app.BackStackRecord> records,
            ArrayList<Boolean> isRecordPop) {
     ...
     */
    private void executeOpsTogether(ArrayList<androidx.fragment.app.BackStackRecord> records,
        ...
        androidx.fragment.app.Fragment oldPrimaryNav = getPrimaryNavigationFragment();
        for (int recordNum = startIndex; recordNum < endIndex; recordNum++) {
            final androidx.fragment.app.BackStackRecord record = records.get(recordNum);
            final boolean isPop = isRecordPop.get(recordNum);
            if (!isPop) {
				//执行 expandReplaceOps 方法把 replace 替换(目标 fragment 已经被 add )成相应的 remove 和 add 两个操作，或者(目标 fragment 没有被 add )只替换成 add 操作
        ...
        if (allowReordering) {
            ArraySet<androidx.fragment.app.Fragment> addedFragments = new ArraySet<>();
     ...
     */
    private void makeRemovedFragmentsInvisible(ArraySet<androidx.fragment.app.Fragment> fragments) {
        final int numAdded = fragments.size();
        for (int i = 0; i < numAdded; i++) {
            final androidx.fragment.app.Fragment fragment = fragments.valueAt(i);
            if (!fragment.mAdded) {
     ...
     * postponed.
     */
    private int postponePostponableTransactions(ArrayList<androidx.fragment.app.BackStackRecord> records,
            ArrayList<Boolean> isRecordPop, int startIndex, int endIndex,
            ArraySet<androidx.fragment.app.Fragment> added) {
        int postponeIndex = endIndex;
        for (int i = endIndex - 1; i >= startIndex; i--) {
            final androidx.fragment.app.BackStackRecord record = records.get(i);
     ...
     */
    private void completeExecute(androidx.fragment.app.BackStackRecord record, boolean isPop, boolean runTransitions,
                                 boolean moveToState) {
        if (isPop) {
        ...
        ArrayList<androidx.fragment.app.BackStackRecord> records = new ArrayList<>(1);
        ...
        if (mActive != null) {
            ...
            for (int i = 0; i < numActive; i++) {
                ...
                androidx.fragment.app.Fragment fragment = mActive.valueAt(i);
     ...
     */
    private androidx.fragment.app.Fragment findFragmentUnder(androidx.fragment.app.Fragment f) {
        final ViewGroup container = f.mContainer;
        ...
        for (int i = fragmentIndex - 1; i >= 0; i--) {
            androidx.fragment.app.Fragment underFragment = mAdded.get(i);
     ...
     */
    private static void executeOps(ArrayList<androidx.fragment.app.BackStackRecord> records,
            ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
     ...
     * postponed with {@link androidx.fragment.app.Fragment#postponeEnterTransition()}. They will later be made
     * invisible (by setting their alpha to 0) if they have been removed when postponed.
     */
    private void addAddedFragments(ArraySet<androidx.fragment.app.Fragment> added) {
        if (mCurState < androidx.fragment.app.Fragment.CREATED) {
            return;
        }
        // We want to leave the fragment in the started state
        final int state = Math.min(mCurState, androidx.fragment.app.Fragment.STARTED);
        final int numAdded = mAdded.size();
        for (int i = 0; i < numAdded; i++) {
            androidx.fragment.app.Fragment fragment = mAdded.get(i);
     ...
     *              pop action.
     */
     //遍历 mPendingActions 调用 OpGenerator.generateOps() 方法生成 BackStackRecord 添加到 mTmpRecords 
     //并把是否为出栈添加到 mTmpIsPop 中，然后调用 mPendingActions.clear() 把待执行动作列表清空，因为已经被转化为 BackStackRecord 列表
    private boolean generateOpsForPendingActions(ArrayList<androidx.fragment.app.BackStackRecord> records,
    ...
    void addBackStackState(androidx.fragment.app.BackStackRecord state) {
        if (mBackStack == null) {
            mBackStack = new ArrayList<androidx.fragment.app.BackStackRecord>();
        }
        mBackStack.add(state);
    }

    @SuppressWarnings("unused")
    boolean popBackStackState(ArrayList<androidx.fragment.app.BackStackRecord> records, ArrayList<Boolean> isRecordPop,
        ...
        if (name == null && id < 0 && (flags & POP_BACK_STACK_INCLUSIVE) == 0) {
            ...
            if (name != null || id >= 0) {
                ...
                while (index >= 0) {
                    androidx.fragment.app.BackStackRecord bss = mBackStack.get(index);
    ...
    private static void setRetaining(FragmentManagerNonConfig nonConfig) {
        ...
        List<androidx.fragment.app.Fragment> fragments = nonConfig.getFragments();
        if (fragments != null) {
    ...
    void saveNonConfig() {
        ArrayList<androidx.fragment.app.Fragment> fragments = null;
    ...
    void saveFragmentViewState(androidx.fragment.app.Fragment f) {
    ...
    Bundle saveFragmentBasicState(androidx.fragment.app.Fragment f) {
        Bundle result = null;
    ...
    Parcelable saveAllState() {
        ...
        for (int i=0; i<N; i++) {
            ...
            if (f != null) {
                ...
                if (f.mState > androidx.fragment.app.Fragment.INITIALIZING && fs.mSavedFragmentState == null) {
        ...
        int[] added = null;
        androidx.fragment.app.BackStackState[] backStack = null;
        ...
        if (mBackStack != null) {
            N = mBackStack.size();
            if (N > 0) {
                backStack = new androidx.fragment.app.BackStackState[N];
                for (int i=0; i<N; i++) {
                    backStack[i] = new androidx.fragment.app.BackStackState(mBackStack.get(i));
    ...
    void restoreAllState(Parcelable state, FragmentManagerNonConfig nonConfig) {
        ...
        if (nonConfig != null) {
            List<androidx.fragment.app.Fragment> nonConfigFragments = nonConfig.getFragments();
            childNonConfigs = nonConfig.getChildNonConfigs();
            viewModelStores = nonConfig.getViewModelStores();
            final int count = nonConfigFragments != null ? nonConfigFragments.size() : 0;
            for (int i = 0; i < count; i++) {
                androidx.fragment.app.Fragment f = nonConfigFragments.get(i);
        ...
        for (int i=0; i<fms.mActive.length; i++) {
            ...
            if (fs != null) {
                ...
                androidx.fragment.app.Fragment f = fs.instantiate(mHost, mContainer, mParent, childNonConfig,
                        viewModelStore);
        ...
        if (fms.mAdded != null) {
            for (int i=0; i<fms.mAdded.length; i++) {
                androidx.fragment.app.Fragment f = mActive.get(fms.mAdded[i]);
                if (f == null) {
                    throwException(new IllegalStateException(
        ...
        if (fms.mBackStack != null) {
            mBackStack = new ArrayList<androidx.fragment.app.BackStackRecord>(fms.mBackStack.length);
            for (int i=0; i<fms.mBackStack.length; i++) {
                androidx.fragment.app.BackStackRecord bse = fms.mBackStack[i].instantiate(this);
                if (DEBUG) {
    ...
    public void attachController(FragmentHostCallback host,
                                 FragmentContainer container, androidx.fragment.app.Fragment parent) {
    ...
    public void dispatchCreate() {
        mStateSaved = false;
        mStopped = false;
        dispatchStateChange(androidx.fragment.app.Fragment.CREATED);
    }

    public void dispatchActivityCreated() {
        mStateSaved = false;
        mStopped = false;
        dispatchStateChange(androidx.fragment.app.Fragment.ACTIVITY_CREATED);
    }

    public void dispatchStart() {
        mStateSaved = false;
        mStopped = false;
        dispatchStateChange(androidx.fragment.app.Fragment.STARTED);
    }

    public void dispatchResume() {
        mStateSaved = false;
        mStopped = false;
        dispatchStateChange(androidx.fragment.app.Fragment.RESUMED);
    }
    ...
    public void dispatchDestroy() {
        mDestroyed = true;
        execPendingActions();
        dispatchStateChange(androidx.fragment.app.Fragment.INITIALIZING);
        mHost = null;
        mContainer = null;
        mParent = null;
    }
    ...
    public void dispatchMultiWindowModeChanged(boolean isInMultiWindowMode) {
        for (int i = mAdded.size() - 1; i >= 0; --i) {
            final androidx.fragment.app.Fragment f = mAdded.get(i);
            if (f != null) {
    ...
    public boolean dispatchCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        boolean show = false;
        ArrayList<androidx.fragment.app.Fragment> newMenus = null;
        for (int i = 0; i < mAdded.size(); i++) {
            androidx.fragment.app.Fragment f = mAdded.get(i);
            if (f != null) {
                if (f.performCreateOptionsMenu(menu, inflater)) {
                    show = true;
                    if (newMenus == null) {
                        newMenus = new ArrayList<androidx.fragment.app.Fragment>();
                    }
                    newMenus.add(f);
                }
            }
    ...
    @SuppressWarnings("ReferenceEquality")
    public void setPrimaryNavigationFragment(androidx.fragment.app.Fragment f) {
    ...
    void dispatchOnFragmentPreAttached(@NonNull androidx.fragment.app.Fragment f, @NonNull Context context,
    ...
    void dispatchOnFragmentAttached(@NonNull androidx.fragment.app.Fragment f, @NonNull Context context,
                                    boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentPreCreated(@NonNull androidx.fragment.app.Fragment f, @Nullable Bundle savedInstanceState,
                                      boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentCreated(@NonNull androidx.fragment.app.Fragment f, @Nullable Bundle savedInstanceState,
                                   boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentActivityCreated(@NonNull androidx.fragment.app.Fragment f, @Nullable Bundle savedInstanceState,
                                           boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentViewCreated(@NonNull androidx.fragment.app.Fragment f, @NonNull View v,
    ...
    void dispatchOnFragmentStarted(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentResumed(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentPaused(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentStopped(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentSaveInstanceState(@NonNull androidx.fragment.app.Fragment f, @NonNull Bundle outState,
                                             boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentViewDestroyed(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentDestroyed(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentDetached(@NonNull androidx.fragment.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (!androidx.fragment.app.Fragment.isSupportFragmentClass(mHost.getContext(), fname)) {
        ...
        androidx.fragment.app.Fragment fragment = id != View.NO_ID ? findFragmentById(id) : null;
        ...
        if (mCurState < androidx.fragment.app.Fragment.CREATED && fragment.mFromLayout) {
            moveToState(fragment, androidx.fragment.app.Fragment.CREATED, 0, 0, false);
        } else {
            moveToState(fragment);
        }
    ...
    interface OpGenerator {
         ...
         */
        boolean generateOps(ArrayList<androidx.fragment.app.BackStackRecord> records, ArrayList<Boolean> isRecordPop);
    }
    ...
    private class PopBackStackState implements OpGenerator {
        ...
        @Override
        public boolean generateOps(ArrayList<androidx.fragment.app.BackStackRecord> records,
                ArrayList<Boolean> isRecordPop) {
            if (mPrimaryNav != null // We have a primary nav fragment
     ...
     * {@link androidx.fragment.app.Fragment#startPostponedEnterTransition()} is called or a transaction is started
     * that interacts with this one, based on interactions with the fragment container.
     */
    static class StartEnterTransitionListener
            implements androidx.fragment.app.Fragment.OnStartEnterTransitionListener {
        private final boolean mIsBack;
        private final androidx.fragment.app.BackStackRecord mRecord;
        private int mNumPostponed;

        StartEnterTransitionListener(androidx.fragment.app.BackStackRecord record, boolean isBack) {
            mIsBack = isBack;
            mRecord = record;
        }

        /**
         * Called from {@link androidx.fragment.app.Fragment#startPostponedEnterTransition()}, this decreases the
        ...
        /**
         * Called from {@link androidx.fragment.app.Fragment#
